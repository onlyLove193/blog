...
<body style="background:#f0f9fd;">
    ...
    <span><img src="/App/Admin/View/Public/images/leftico01.png" /></span>管理信息
        ...
        <li><cite></cite><a href="<?php echo U('Imagelist/other');?>" target="rightFrame">评论列表</a><i></i></li>
        <li><cite></cite><a href="<?php echo U('Tools/index');?>" target="rightFrame">评论管理</a><i></i></li>
        <!--li><cite></cite><a href="<?php echo U('Filelist/index');?>" target="rightFrame">信息管理</a><i></i></li-->
        <li><cite></cite><a href="<?php echo U('Tab/index');?>" target="rightFrame">Tab页</a><i></i></li>
    ...
    <ul class="menuson">
        ...
        <li><cite></cite><a href="#">主题管理</a><i></i></li>
        <li><cite></cite><a href="#">验证码管理</a><i></i></li>
        </ul>     
    </dd> 
    
    
    <dd><div class="title"><span><img src="/App/Admin/View/Public/images/leftico03.png" /></span>编辑器</div>
    <ul class="menuson">
