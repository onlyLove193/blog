...
<body style="background:#f0f9fd;">
    ...
    <span><img src="/App/Admin/View/Public/images/leftico01.png" /></span>管理信息
        ...
        <li><cite></cite><a href="<?php echo U('Clist/index');?>" target="rightFrame">栏目列表</a><i></i></li>
        <li><cite></cite><a href="<?php echo U('Blog/index');?>" target="rightFrame">添加栏目</a><i></i></li>
        <li><cite></cite><a href="<?php echo U('Bmanage/index');?>" target="rightFrame">栏目管理</a><i></i></li>
