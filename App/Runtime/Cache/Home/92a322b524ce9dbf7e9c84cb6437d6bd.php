  ...
  <article>
    ...
    <div class="index_about">
      ...
      <ul class="infos">
        ...
        <p>如果你更喜欢用蓝色或者绿色，这也不错，替换关键的颜色值就行了，推荐颜色值：<img src="/Public/images/color.jpg" alt="黑色Html5个人博客模板"></p>
        <p>Html5响应式两栏布局，LOGO重点突出，首页推荐文章列表以Logo中轴线为时间轴，鼠标Hover触发时间轴左侧栏显示文章发布时间，文字banner动画均以css3代码来实现效果。</p>
        <p><b>首页效果图：</b></p>
        <p><img src="/Public/images/xgt.jpg" alt="黑色Html5个人博客模板"></p>
        <p><b>移动设备和平板电脑浏览效果：</b></p>
        <p><img src="/Public/images/ltpic.jpg" alt="黑色Html5个人博客模板"></p>
        <p><img src="/Public/images/col.jpg" alt="黑色Html5个人博客模板"></p>
      </ul>
      <div class="keybq">
